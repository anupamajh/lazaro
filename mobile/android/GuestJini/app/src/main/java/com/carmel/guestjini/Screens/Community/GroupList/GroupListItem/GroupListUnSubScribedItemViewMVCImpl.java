...
public class GroupListUnSubScribedItemViewMVCImpl
    ...
    public GroupListUnSubScribedItemViewMVCImpl(
            LayoutInflater inflater,
            @Nullable ViewGroup parent
    ) {
        setRootView(inflater.inflate(R.layout.layout_community_group_list_unsubscribed_group_item, parent, false));
