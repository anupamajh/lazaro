...
public class GroupListItemViewMVCImpl
    ...
    public GroupListItemViewMVCImpl(
            LayoutInflater inflater,
            @Nullable ViewGroup parent
    ) {
        setRootView(inflater.inflate(R.layout.layout_community_group_list_normal_group_item, parent, false));
