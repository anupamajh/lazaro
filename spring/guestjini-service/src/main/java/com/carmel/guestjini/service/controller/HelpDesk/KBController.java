...
import com.carmel.guestjini.service.response.HelpDesk.KBResponse;
import com.carmel.guestjini.service.service.HelpDesk.KBService;
...
import static com.carmel.guestjini.service.specification.HelpDesk.KBSpecification.textInAllColumns;
...
public class KBController {
    ...
    public  @ResponseBody
    byte[] kbAuthorPic(@RequestBody Map<String, String> formData) {
        try {
            Optional<KB> optionalKB = kbService.findById(formData.get("id"));
            if (optionalKB.isPresent()) {
                KB kb = optionalKB.get();
