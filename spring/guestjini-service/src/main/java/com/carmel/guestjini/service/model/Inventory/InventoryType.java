package com.carmel.guestjini.service.model.Inventory;
...
public class InventoryType {
    ...
    @NotNull(message = "Inventory Type title cannot be null")
    private String title;

    @Column(name = "narration")
    @Length(max = 255, min = 1, message = "Inventory Type narration length should be between 1 and 255")
    private String narration;

    @Column(name = "system_constant")
