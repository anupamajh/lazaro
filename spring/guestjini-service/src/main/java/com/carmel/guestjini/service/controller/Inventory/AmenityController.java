...
import com.carmel.guestjini.service.model.DTO.Inventory.AmenityDTO;
...
import com.carmel.guestjini.service.response.Inventory.AmenityResponse;
...
import static com.carmel.guestjini.service.specification.Inventory.AmenitySpecification.textInAllColumns;
    ...
    public AmenityResponse searchPaginated(@RequestBody Map<String, String> formData) {
        ...
        try {
            ...
            if (searchText == null) {
                ...
                page = amenityService.findAll(textInAllColumns(searchText, userInfo.getClient().getClientId()), pageable);
            }
            amenityResponse.setTotalRecords(page.getTotalElements());
            amenityResponse.setTotalPages(page.getTotalPages());
            amenityResponse.setAmenityList(page.getContent());
