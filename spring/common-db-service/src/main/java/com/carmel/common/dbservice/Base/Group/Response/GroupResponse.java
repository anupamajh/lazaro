package com.carmel.common.dbservice.Base.Group.Response;
...
import com.carmel.common.dbservice.model.DTO.GroupPeopleDTO;
...
public class GroupResponse {
    ...
    public void setGroupListWithInterestCategory(List<Group> groupList,
        ...
        groupList.forEach(group1 -> {
            ...
            Optional<UserInterestsDTO> optionalUserInterests = userInterests.stream().filter(ui -> ui.getInterestId().equals(group1.getInterestId()) && ui.getIsInterested() == 1).findFirst();
