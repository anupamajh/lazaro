package com.carmel.common.dbservice.controller.Instagram;

import com.carmel.common.dbservice.component.UserInformation;
import com.carmel.common.dbservice.controller.Facebook.FacebookController;
import com.carmel.common.dbservice.response.Instagram.InstagramResponse;
import com.carmel.common.dbservice.services.Instagram.InstagramService;
...
public class InstagramController {
    ...
    public InstagramResponse importData() {
        ...
        try {
            instagramResponse = instagramService.importData(path);
        } catch (Exception ex) {
    ...
    @RequestMapping(value = "/instagram-import-data", method = RequestMethod.POST)
    ...
    private void importLinkedInData(String filepath) throws Exception {
        InstagramResponse instagramResponse = instagramService.importData(filepath);
    }
