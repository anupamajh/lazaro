...
import com.carmel.guestjini.inventory.response.InventoryTypeResponse;
import com.carmel.guestjini.inventory.services.InventoryTypeService;
import com.carmel.guestjini.inventory.specifications.InventoryTypeSpecification;
    ...
    public InventoryTypeResponse searchPaginated(@RequestBody Map<String, String> formData) {
        ...
        try {
            ...
            if (searchText == null) {
                ...
                page = inventoryTypeService.findAll(InventoryTypeSpecification.textInAllColumns(searchText, userInfo.getClient().getClientId()), pageable);
            }
            inventoryTypeResponse.setTotalRecords(page.getTotalElements());
            inventoryTypeResponse.setTotalPages(page.getTotalPages());
            inventoryTypeResponse.setInventoryTypeList(page.getContent());
